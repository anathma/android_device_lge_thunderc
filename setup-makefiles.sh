...
## HAL
PRODUCT_COPY_FILES += \\
    vendor/__VENDOR__/__DEVICE__/proprietary/lib/hw/sensors.thunderc.so:system/lib/hw/sensors.thunderc.so \\
    vendor/__VENDOR__/__DEVICE__/proprietary/lib/hw/gralloc.thunderc.so:system/lib/hw/gralloc.thunderc.so
