...
## HAL
adb pull /system/lib/hw/sensors.thunderc.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib/hw/sensors.thunderg.so
adb pull /system/lib/hw/gralloc.thunderc.so ../../../vendor/$VENDOR/$DEVICE/proprietary/lib/hw/
