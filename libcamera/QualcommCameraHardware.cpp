...
board_property boardProperties[] = {
        ...
        {TARGET_MSM7627, 0x000006ff, true, true, false},
        {TARGET_MSM7627A, 0x000006ff, false, false, false},
        {TARGET_MSM7630, 0x00000fff, false, false, false},
        {TARGET_MSM8660, 0x00001fff, false, false, false},
...
status_t QualcommCameraHardware::takeLiveSnapshot()
{
    ...
    if(!LINK_set_liveshot_params(videoWidth, videoHeight,
      ...
      (uint8_t *)/*mJpegHeap->mHeap->base()*/mJpegMapped->data, maxjpegsize)) {
        LOGE("Link_set_liveshot_params failed.");
      //TODO :  mJpegHeap.clear();
        return NO_ERROR;
    }
